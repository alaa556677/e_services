import 'package:e_services/admin_features/admin_gas/pages/admin_gas_maintenance_screen.dart';
import 'package:e_services/core/widgets/default_screen.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';

class AdminGasMaintenanceRequestScreen extends StatelessWidget {
            ...
            itemBuilder: (BuildContext context,int index)=>Container(
              ...
              child: Card(
                ...
                child: ListTile(
                  ...
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) =>  AdminGasMaintenanceScreen()));
                  },
