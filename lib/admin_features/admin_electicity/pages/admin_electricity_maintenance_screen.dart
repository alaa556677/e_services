...
class AdminElectricityMaintenanceScreen extends StatelessWidget {
  const AdminElectricityMaintenanceScreen({super.key});
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Center(child: Text("عداد الكهرباء لا يعمل بشكل جيد ويحتاج الي صيانة فورية",style: TextStyle(color: Colors.black,fontSize: 20.0,fontWeight: FontWeight.bold),)),
                Container(
                  decoration: BoxDecoration(
                    border: Border.all(color: textGreyColor),
                    //  borderRadius: BorderRadius.circular(10),
