import 'package:e_services/admin_features/admin_water/presentation/pages/admin_water_meter_readin_screen.dart';
import 'package:e_services/core/widgets/default_screen.dart';
import 'package:flutter/material.dart';

class AdminWaterMeterReadingRequestScreen extends StatelessWidget {
            ...
            itemBuilder: (BuildContext context,int index)=>Container(
              ...
              child: Card(
                ...
                child: ListTile(
                  ...
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) =>  AdminWaterMeterReadingScreen()));
                  },
