...
import 'package:e_services/admin_features/admin_water/presentation/pages/admin_water_maintenance_screen.dart';
import 'package:e_services/admin_features/admin_water/presentation/pages/admin_water_remove_meter_screen.dart';
import 'package:e_services/core/widgets/default_screen.dart';
import 'package:flutter/material.dart';

class AdminWaterRemoveMeterRequestsScreen extends StatelessWidget {
            ...
            itemBuilder: (BuildContext context,int index)=>Container(
              ...
              child: Card(
                ...
                child: ListTile(
                  ...
                  trailing: Text("نوع الخدمة: صيانة عداد"),
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) =>  AdminWaterRemoveMeterScreen()));
                  },
